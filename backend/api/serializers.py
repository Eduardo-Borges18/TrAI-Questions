...
class QuestionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model  = Question
        fields = ["id", "order_num", "statement", "question_type", "question_type_label",
                  "difficulty", "difficulty_label", "alternatives"]
...
class ExamListSerializer(serializers.ModelSerializer):
    ...
    def get_difficulty_label(self, obj):
        # Pega a dificuldade da primeira questão como referência do nível da prova
...
class ExamDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model  = Exam
        fields = ["id", "title", "subject", "description", "questions", "created_at"]
...
class SubmissionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model  = Submission
        fields = ["id", "question", "exam", "answer_text", "submitted_at", "feedback"]
